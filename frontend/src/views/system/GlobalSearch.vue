...
.res-item { display: flex; align-items: center; gap: 8px; padding: 8px 4px; border-bottom: 1px solid $n-50; cursor: pointer; color: $n-900; }
.res-item:hover { background: $brand-100; }
</style>