...
.report-area { background: $n-0; border: 1px solid $n-200; border-radius: 8px; padding: 28px; }
.report-header { border-bottom: 2px solid $brand-600; padding-bottom: 12px; margin-bottom: 16px; }
.report-header h1 { margin: 0; color: $n-900; }
.rpt-date { color: $n-600; font-size: 13px; margin-top: 6px; }
.rpt-kpi { display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; margin-bottom: 20px; }
.kpi-cell { border: 1px solid $n-200; border-radius: 6px; padding: 14px; text-align: center; }
.kpi-val { font-size: 24px; font-weight: 700; color: $n-900; }
.kpi-lab { margin-top: 4px; color: $n-600; font-size: 12px; }
.rpt-table { width: 100%; border-collapse: collapse; font-size: 13px; }
.rpt-table th, .rpt-table td { border: 1px solid $n-200; padding: 8px; text-align: center; }
.rpt-table th { background: $n-50; }
.struct-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; }
.struct-item { border: 1px solid $n-200; border-radius: 6px; padding: 12px; }
.struct-tag { font-weight: 600; margin-bottom: 8px; color: $n-900; }
